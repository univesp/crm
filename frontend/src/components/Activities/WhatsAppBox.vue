<template>
  ...
  >
    <div
      class="mb-1 ml-13 flex flex-1 cursor-pointer gap-2 rounded bg-surface-gray-2 p-2 text-base text-ink-gray-5"
    >
      <div
        class="w-1 shrink-0 rounded-full"
        :class="reply.type == 'Incoming' ? 'bg-green-500' : 'bg-blue-400'"
      />
