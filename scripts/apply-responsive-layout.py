...
REPLACEMENTS: tuple[tuple[str, str], ...] = (
	...
	(
		'class="mt-1 grid grid-cols-5 gap-1 text-center text-[10px] font-semibold text-slate-400"',
		'class="crm-stat-grid mt-1 gap-1 text-center text-[10px] font-semibold text-slate-400"',
	),
	...
	(
		'class="grid gap-3 rounded-[8px] border border-slate-200 bg-white/88 p-5 md:grid-cols-[minmax(0,1fr)_180px]"',
		'class="crm-filter-grid rounded-[8px] border border-slate-200 bg-white/88 p-5"',
	),
	(
	...
	(
		'class="mt-3 max-h-[260px] overflow-auto rounded-[8px] border border-slate-200"',
		'class="crm-table-scroll crm-table-scroll--bounded mt-3"',
	),
	(
		'class="mt-3 max-h-[280px] overflow-auto rounded-[8px] border border-slate-200"',
		'class="crm-table-scroll crm-table-scroll--bounded-lg mt-3"',
	),
	(
		'class="overflow-x-auto rounded-[8px] border border-slate-200 bg-white"',
		'class="crm-table-scroll rounded-[8px] border border-slate-200 bg-white"',
	),
	...
	(
		'class="grid gap-4 border-t border-slate-200 px-4 py-4 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]"',
		'class="crm-split-grid gap-4 border-t border-slate-200 px-4 py-4"',
	),
	(
		'class="grid gap-4 border-t border-slate-200 px-4 py-4 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]"',
		'class="crm-split-grid gap-4 border-t border-slate-200 px-4 py-4"',
	),
	('class="grid gap-3 lg:grid-cols-[1fr_360px]"', 'class="crm-split-grid crm-split-grid--sidebar gap-3"'),
	(
		'class="grid gap-6 xl:grid-cols-[0.9fr_1.25fr_0.85fr]"',
		'class="crm-split-grid crm-split-grid--triple gap-6"',
	),
	(
		'class="mt-5 grid gap-3 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]"',
		'class="crm-split-grid mt-5 gap-3"',
	),
	(
		'class="mt-4 grid gap-3 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]"',
		'class="crm-split-grid mt-4 gap-3"',
	),
	(
		'class="mt-6 grid gap-3 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]"',
		'class="crm-split-grid mt-6 gap-3"',
	),
	...
	(
		'class="mt-3 grid gap-3 xl:grid-cols-[1fr_390px]"',
		'class="crm-split-grid crm-split-grid--sidebar mt-3 gap-3"',
	),
	...
	(
		'class="grid gap-3 rounded-[8px] border border-slate-200 bg-white p-4 lg:grid-cols-[1.5fr_1fr_1fr_1fr]"',
		'class="crm-filter-grid--dense rounded-[8px] border border-slate-200 bg-white p-4"',
	),
